                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="<?= base_url('user') ?>">Beranda materi</a>
                             <li class="nav-item "><a class="nav-link" href="<?= base_url('user') ?>">Beranda Bimbel</a>
                            </li>
                            </li>
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Students! , Ini merupakan halaman mapel learnify ! Silahkan pilih mapel yang akan kamu
                        akses
                        dan didalamnya meliputi modul materi dan video materi siap disaksikan! Selamat belajar ya students!</p>
                    <hr>
                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                        ...
                        <h5>Mata Pelajaran Kelas X IPA </h5>
                </div>
            </div>
        </div>
    </div>

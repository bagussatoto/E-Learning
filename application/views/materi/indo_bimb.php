...
<head>
    ...
    <title>Bahasa Indonesia | Kelas X - Learnify</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item "><a class="nav-link" href="<?= base_url('user') ?>">Beranda materi</a>
                             <li class="nav-item active"><a class="nav-link" href="<?= base_url('user') ?>">Beranda Bimbel</a>
                            </li>
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    ...
                    <p>Bahasa Indonesia - Kelas X IPA </p>
                    <hr width="80%">
                ...
                <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
                    <div class="card materi w-150 border-0">
                        <div class="card-body p-5">
                            ...
                            <a href="<?php echo site_url('bimbel/bimbel/' . $u->id_bimbel); ?>" class="btn btn-white">Pelajari
                                Sekarang !</a>
                        </div>
                    </div>
                </div>

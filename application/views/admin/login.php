        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <a href="<?=base_url('welcome')?>"> <img src="<?=base_url('assets/')?>/img/logo2.png" alt="logo"
                                width="150" class=" mb-5 mt-2"></a>
                        <h4 class="text-dark font-weight-normal">Selamat datang di <span
                                class="font-weight-bold">Learnify Education</span>
                        </h4>
                        ...
                        <form method="post" action="<?=base_url('welcome/admin')?>" class="needs-validation"
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="form-control" name="email" tabindex="1" required
                                    autofocus value="<?= $this->session->flashdata('email'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" type="password" class="form-control" name="password" tabindex="2" value="<?= $this->session->flashdata('password'); ?>"
                                    required>
                                <div class="invalid-feedback">
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb"
                                target="_blank" href="">Vera Kristina</a> - Image by <a
